...
export {
    ...
    MAINGUNXL, SECGUN, SECGUNAA, AAGUN,
    AAFD, TORPEDO, TORPEDOSS, MIDGETSUB,
    FIGHTER, TORPBOMBER, DIVEBOMBER, SEAPLANE,
    SEAPLANEBOMBER, CARRIERSCOUT, AUTOGYRO,
    ASWPLANE, RADARS, RADARL, RADARXL,
    SONARS, SONARL, DEPTHCHARGE, ENGINE,
    APSHELL, TYPE3SHELL, BULGEM, BULGEL,
    LANDINGCRAFT, SEARCHLIGHTS, SEARCHLIGHTL, STARSHELL,
    PICKET, WG42, SRF, FCF,
    DRUM, SCAMP, FLYINGBOAT, NIGHTSCOUT,
    REPAIR, RATION, SEAPLANEFIGHTER, LANDINGTANK,
    OILDRUM, LANDBOMBER, INTERCEPTOR, OTHER
};
...
export {
    B_MAINGUN, B_SECGUN, B_RECON, B_RADAR,
    B_APSHELL, B_SONAR, B_DEPTHCHARGE, B_TORPEDO,
    B_TYPE3SHELL, B_LC1, B_LC2, B_LC3,
    B_OTHER,
}
...
export {
    A_HAGUN, A_AAFD, A_HAFD, A_MAINGUNL,
    A_TYPE3SHELL, A_AIRRADAR, A_AAGUN, A_GUN,
    A_XLGUN,
}
